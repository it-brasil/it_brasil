...
class CashFlowReport(models.AbstractModel):
    _name = "report.account_report_cash_flow.cash_flow"
    _description = "Cash Flow Report"
    _inherit = "report.account_report_cash_flow.abstract_report"
    ...
    def _get_data(
        ...
        move_lines = self.env["account.move.line"].search_read(
            domain=domain, fields=ml_fields, order="account_id"
        )
        journals_ids = set()
        partners_ids = set()
        partners_data = {}
    ...
    def _get_report_values(self, docids, data):
        ...
        # }
        balance_amount = {}
        # balance_amount["balance"] = 0.0
        for balance in balance_values:
            x = balance
        #     balance_amount[balance['account_id'][0]] = {}
        #     balance_amount[balance['account_id'][0]]["residual"] = balance["balance"]
