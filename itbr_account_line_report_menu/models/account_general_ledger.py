...
class AccountGeneralLedgerReport(models.AbstractModel):
    ...
    def _get_query_amls(self, options, expanded_account, offset=None, limit=None):
        ...
        query = '''
            ...
            LEFT JOIN l10n_br_fiscal_document_line account_move_line__fiscal_document_line_id  
                ON account_move_line__fiscal_document_line_id.id =  account_move_line.fiscal_document_line_id
            WHERE %s
