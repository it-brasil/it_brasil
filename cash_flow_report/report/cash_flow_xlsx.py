...
class CashFlowReportXslx(models.AbstractModel):
    _name = "report.a_f_r.report_cash_flow_report_xlsx"
    ...
    def _generate_report_content(self, workbook, report, data, report_data):
        res_data = self.env[
            "report.financial_report.cash_flow"
    ...
    def write_ending_balance_from_dict(
        ...
        super(CashFlowXslx, self).write_ending_balance_from_dict(
